	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-4">
				...
				<div class="row">
					<div class="col">
						<button id="buttonTropAgreable" type="button" class="btn blue" onclick="ajouterEntreprise()">Créer le compte pilote</button>
					</div>
					<div class="col">
						<button id="buttonTropAgreable" type="button" class="btn green" onclick="ajouterEntreprise()">Modifier le compte pilote</button>
					</div>
					<div class="col">
						<button id="buttonTropAgreable" type="button" class="btn yellow" onclick="ajouterEntreprise()">Supprimer le compte pilote</button>
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="Nom du pilote" aria-label="Nom" aria-describedby="basic-addon1">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="Prénom du pilote" aria-label="Nom" aria-describedby="basic-addon1">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="Centre de formation du pilote" aria-label="Nom d'utilisateur" aria-describedby="basic-addon1">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="ex : A3" aria-label="Nom d'utilisateur" aria-describedby="basic-addon1">
					</div>
