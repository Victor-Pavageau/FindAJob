		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-4">
					...
					<div class="row">
						<div class="col">
							<button id="buttonTropAgreable" type="button" class="btn blue" onclick="ajouterEntreprise()">Ajouter l'Entreprise</button>
						</div>
						<div class="col">
							<button id="buttonTropAgreable" type="button" class="btn green" onclick="ajouterEntreprise()">Modifier l'Entreprise</button>
						</div>
						<div class="col">
							<button id="buttonTropAgreable" type="button" class="btn yellow" onclick="ajouterEntreprise()">Noter l'Entreprise</button>
						</div>
