...
<html lang="fr">
    ...
    <body>
        ...
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
            précisé aux utilisateurs du site <a href="{{route('home')}}">www.trouve1stage.fr</a> l'identité des
        ...
        <p><strong>Propriétaire</strong> : Guillaume Rouvin – indépendant – 100 Rue des Echarmeaux Beaujeu<br />
            <strong>Créateur</strong> : <a href="{{route('home')}}">NOSSAIR, ROUVIN, LEBOULANGER, PAVAGEAU</a><br />
        ...
        <p>L’utilisation du site <a href="{{route('home')}}">www.trouve1stage.fr</a> implique l’acceptation pleine
            ...
            href="{{route('home')}}">www.trouve1stage.fr</a> sont donc invités à les consulter de manière
            régulière.</p>
        ...
        <p>Le site <a href="{{route('home')}}">www.trouve1stage.fr</a> est mis à jour régulièrement par ROUVIN
        ...
        <p>Le site <a href="{{route('home')}}">www.trouve1stage.fr</a> a pour objet de fournir une information
            concernant l’ensemble des activités de la société.</p>
        <p>Guillaume Rouvin s’efforce de fournir sur le site <a href="{{route('home')}}">www.trouve1stage.fr</a>
        ...
        <p>Tous les informations indiquées sur le site <a href="{{route('home')}}">www.trouve1stage.fr</a> sont
            données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site
            <a href="{{route('home')}}">www.trouve1stage.fr</a> ne sont pas exhaustifs. Ils sont donnés sous
        ...
        <p>Guillaume Rouvin ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte
            ...
            href="{{route('home')}}">www.trouve1stage.fr</a>.</p>
        ...
        <p>A l'occasion de l'utilisation du site <a href="{{route('home')}}">www.trouve1stage.fr</a>, peuvent
            êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
            href="{{route('home')}}">www.trouve1stage.fr</a>, le fournisseur d'accès de l'utilisateur,
        ...
        <p> En tout état de cause Guillaume Rouvin ne collecte des informations personnelles relatives à l'utilisateur que
            ...
            href="{{route('home')}}">www.trouve1stage.fr</a>. L'utilisateur fournit ces informations en toute
            connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à
            l'utilisateur du site <a href="{{route('home')}}">www.trouve1stage.fr</a> l’obligation ou non de
        ...
        href="{{route('home')}}">www.trouve1stage.fr</a> n'est publiée à l'insu de l'utilisateur,
            ...
            l'utilisateur du site <a href="{{route('home')}}">www.trouve1stage.fr</a>.</p>
        ...
        <p>Le site <a href="{{route('home')}}">www.trouve1stage.fr</a> contient un certain nombre de liens
        ...
        <p>La navigation sur le site <a href="{{route('home')}}">www.trouve1stage.fr</a> est susceptible de
        ...
        <p>Tout litige en relation avec l’utilisation du site <a href="{{route('home')}}">www.trouve1stage.fr</a>
